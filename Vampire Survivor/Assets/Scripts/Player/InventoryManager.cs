...
public class InventoryManager : MonoBehaviour
{
    ...
    public List<WeaponUpgrade> weaponUpgradeOptions = new List<WeaponUpgrade>();    // List o gupgrade options for weapons
    ...
    public List<UpgradeUI> upgradeUIOptions = new List<UpgradeUI>();    // List of ui for upgrade options present in scene
                    ...
                    for (int i = 0; i < weaponSlots.Count; i++)
                    {
                        if (weaponSlots[i] != null && weaponSlots[i].weaponData == chosenWeaponUpgrade.weaponData)
                        {
                            ...
                            if (!newWeapon)
                            {
                                ...
                                // Set the descriptiona and name to be that of the next level
    ...
    void RemoveUpgradeOptions()
    {
        foreach(var upgradeOption in upgradeUIOptions)
        {
            ...
            DisableUpgradeUI(upgradeOption); // Call the DisableUpgradeUI ,ethod here to disable all UI options before applying upgrades to them
        }
    }
